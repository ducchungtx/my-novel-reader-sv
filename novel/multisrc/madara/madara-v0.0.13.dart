...
getPopularNovel(NovelModel manga) async {
...
getNovelDetail(NovelModel manga) async {
  final statusList = [
    {
      "OnGoing": 0,
      "Продолжается": 0,
...
getChapterUrl(NovelModel manga) async {
  final datas = {
    "url": manga.link,
    "headers": null,
    "sourceId": manga.sourceId
...
getLatestUpdatesNovel(NovelModel manga) async {
...
searchNovel(NovelModel manga) async {
